...
def run(context: dict) -> dict:
    ...
    print("\n" + "="*70)
    print("📊 KẾT QUẢ ARDL TRÊN 80 QUAN SÁT (NO PCA)")
    ...
    results_dir = context["PROJECT_ROOT"] / "outputs_no_PCA" / "ardl_vnindex_forecast"
    results_dir.mkdir(parents=True, exist_ok=True)
    forecast_path = results_dir / f"ardl_no_pca_test_forecast_80obs_P{selected_pair[0]}_Q{selected_pair[1]}.csv"
